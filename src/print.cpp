...
{
    return "Complexity 2.1.0 (2025-05-04)";
}
...
auto getHelp() -> std::string
{
    return
        ...
        "     \033[1m./complexity\033[0m [\033[1m-vh\033[0m] [\033[1m-s\033[0m \033[4mseed\033[0m] [\033[1m-o\033[0m \033[4mfile\033[0m] [\033[1m-f\033[0m \033[4mfile\033[0m] [\033[1m-t\033[0m \033[4mthreads\033[0m] [\033[1m-k\033[0m \033[4mtimeout\033[0m] \033[4mnumbers\033[0m \033[4miterations\033[0m [\033[4mgoal\033[0m] [\033[4mchecker\033[0m]\n"
        "\n"
...
auto printStart(const program_opts& opts, const program_params& params, const ThreadSafeRandom::seed_type seed) -> void
{
    ...
    std::cout << "\033[97mStarting the test : \033[95m" << params.numbers << "\033[97m elements, \033[95m" << params.
        iterations << "\033[97m iterations\033[0m" << " (seed " << seed << ")";
    std::cout << std::endl;
}
